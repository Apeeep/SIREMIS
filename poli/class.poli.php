			...
			while($row=$query->fetch(PDO::FETCH_ASSOC))
			{
                ...
                <tr>
	                ...
	                <td><?php print($row['diagnosa_dokter']); ?></td>  
	             	<td><div align="center" style="display:flex;gap:10px;justify-content:center"><?php echo "               
...
//==============================================================RIWAYAT===================================================================
	...
	{
		$query = $this->db->prepare("SELECT * FROM v_reg WHERE nama=:nama");
		$query->execute(array(":nama"=>$id));
		$editRow=$query->fetch(PDO::FETCH_ASSOC);
		return $editRow;
	}

	public function viewRiwayat($query)
	{
		$query = $this->db->prepare($query);
		$query->execute();
		if($query->rowCount()>0)
		...
		if($query->rowCount()>0)
		{
			while($row=$query->fetch(PDO::FETCH_ASSOC))
			{
                ...
                <tr>
	                <td><div align="center"><?php print($row['reg_no']); ?></div></td>	               
	                <td><div align="center">
	                <?php echo " <a href='javascript:void(0)' onclick=\"Dokter('$row[reg_no]')\" >Detail</a>";?>
	                </div></td>
	                <td><div align="center">
	                <?php echo " <a href='javascript:void(0)' onclick=\"Tindakan('$row[reg_no]')\" >Detail</a></div></td> "; ?>
	                <td><div align="center">
	                <?php echo " <a href='javascript:void(0)' onclick=\"Resep('$row[reg_no]')\">Detail</a></div></td> "; ?>
	                <td><div align="center">
	                <?php echo " <a href='javascript:void(0)' onclick=\"RujukLAB('$row[reg_no]')\" >Detail</a>";?>
	                </div></td>
	                <td><div align="center">
	                <?php echo " <a href='javascript:void(0)' onclick=\"Rujuk('$row[reg_no]')\">Detail</a></div></td> "; ?>
					...
					<td><div align="center">
	                <?php echo " <a href='javascript:void(0)' onclick=\"Riwayat('$row[nama]')\">Detail</a></div></td> "; ?>
					</td>
                </tr>
                <?php
                $no++;
