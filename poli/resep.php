	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<?php echo "
				<a href='javascript:void(0)' onclick=\"window.open('../siremis-marcil/poli/print_resep.php?reg_no=$id')\"  class='btn btn-primary'><i class='icon-print icon-white'></i> Print</a>
