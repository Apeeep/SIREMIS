		...
		if($query->rowCount()>0)
		{
			while($row=$query->fetch(PDO::FETCH_ASSOC))
			{
                ...
                <tr>
	                ...
	                <td><div align="center">
	                <?php echo " 
	                <a href='javascript:void(0)' onclick=\"window.open('../siremis-marcil/lab/print_hasil.php?reg_no=$row[reg_no]','name','width=900,height=600')\"><i class='icon-print icon-white'></i> Cetak</a>";?>
	                </div></td>
