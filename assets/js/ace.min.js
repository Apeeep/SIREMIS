...
function handle_side_menu() {
  ...
  $("#sidebar-collapse").on(ace.click_event, function () {
    ...
    $(this)
      .find('[class*="icon-"]:eq(0)')
      .toggleClass("icon-double-angle-right");
  ...
  $(".page-content").delegate(
    ...
    function (k) {
      ...
      if (l == "collapse") {
        ...
        if (h.length == 0) {
          d = d
            .wrapInner('<div class="widget-body-inner"></div>')
            .find(":first-child")
            .eq(0);
        } else {
          d = h.eq(0);
        ...
        if (l == "close") {
          ...
          if (l == "reload") {
            ...
            a.append(
              '<div class="widget-box-layer"><i class="icon-spinner icon-spin icon-2x white"></i></div>'
            );
            setTimeout(function () {
...
function switch_direction() {
  ...
  c.toggleClass("rtl")
    ...
    .end()
    .find(".chzn-container")
    .toggleClass("chzn-rtl")
    .end()
    .find('.control-group .controls > [class*="span"]:first-child')
    .toggleClass("pull-right")
    .end();
  function a(g, f) {
    c.find("." + g)
