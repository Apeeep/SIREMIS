...
?>
				<tr>
					...
					<td>
						<div align="center" style="display:flex;gap:10px;justify-content:center">
							<?php echo '
								<a href="javascript:void(0)" onclick=\"editData("$row[username]")\" class="link-info-emphasis" data-bs-toggle="tooltip" data-bs-title="Default tooltip"><i class="fa-solid fa-pen-to-square"></i></a>
								<a href="javascript:void(0)" onclick=\"deleteData("$row[username]")\" class="link-info-emphasis"><i class="fa-solid fa-trash"></i></a>
                			'; ?>
						</div>
					</td>
				</tr>
			...
			?>
				<tr>
					...
					<td><?php print($row['level']); ?></td>
					<td>
						<div align="center"><?php print($row['aktif']); ?></div>
					</td>
				</tr>
			<?php
							$no++;
