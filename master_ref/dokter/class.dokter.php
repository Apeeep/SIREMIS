	...
	public function view($query)
	{
		...
		if($query->rowCount()>0)
		{
			while($row=$query->fetch(PDO::FETCH_ASSOC))
			{
                ...
                <?php echo "                
                <a href='javascript:void(0)' onclick=\"editData('$row[id_dokter]')\" class='ttip' style='text-decoration:none'><i class='icon-trash icon-pencil bigger-130'></i><span class='ttiptext'><strong>EDIT</strong></span></a>
                <a href='javascript:void(0)' onclick=\"deleteData('$row[id_dokter]','$row[nama_dokter]')\" class='ttip' style='text-decoration:none'><i class='icon-trash icon-red bigger-130'></i><span class='ttiptext'><strong>HAPUS</strong></span></a>
                "; ?>
                </div>
                </td>
                </tr>
